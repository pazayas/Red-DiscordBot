...
from ..utils._internal_utils import can_react_in, fuzzy_command_search, format_fuzzy_results
...
class RedHelpFormatter(HelpFormatterABC):
    ...
    async def send_pages(
        ...
        """
        if not (can_react_in(ctx.channel, ctx.me) and help_settings.use_menus):
